...
\title[GFSK Demodulator]% optional, use only with long paper titles
{\large DSP-Based GFSK Demodulator for AAU Ground Station}

\subtitle{Group 627}  % could also be a conference name

\date{June 18, 2014}

\author[Group 627] % optional, use only with lots of authors
{
  Jacob Velling Dueholm\\
  Jacob Møller Hjerrild Hansen\\
  Miklas Strøm Kristoffersen\\
  Søren Bøgeskov Nørgaard\\
  \href{mailto:14gr627@es.aau.dk}{{\tt 14gr627@es.aau.dk}}
}
